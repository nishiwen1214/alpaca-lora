...
- 🤗 **[使用预训练好的模型](https://huggingface.co/spaces/tloen/alpaca-lora), 感谢Huggingface的GPU!**
-  [用户讨论的地方](https://discord.gg/prbq284xX5)
- 4/6: 更新了微软研究院的 [LLaMA-GPT4 dataset](https://github.com/Instruction-Tuning-with-GPT-4/GPT-4-LLM).
